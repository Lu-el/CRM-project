import {renderGoods} from './modules/renderTable.js';
import tableControl from './modules/tableControl.js';
import controlModal from './modules/controlModal.js';
import {formEvent} from './modules/formWork.js';
import {httpRequest} from './modules/serverData.js';
const {
  getTableElements,
  totalPriceTable,
  tbodyControl,
...
export const URL = 'https://enigmatic-chamber-47131.herokuapp.com/api/goods';
...
const init = (err, data) => {
  ...
  formEvent(URL, addProdactForm, tbody, closeModal, totalPriceAll);
